...
struct [[trivially_relocatable(true)]] A1 {};
struct [[trivially_relocatable(false)]] A2 {};
struct [[trivially_relocatable(true)]] A3 { ~A3(); };
struct [[trivially_relocatable(false)]] A4 { ~A4(); };
...
struct [[trivially_relocatable(ValueOf<true>)]] B1 {};
struct [[trivially_relocatable(ValueOf<false>)]] B2 {};
struct [[trivially_relocatable(ValueOf<true>)]] B3 { ~B3(); };
struct [[trivially_relocatable(ValueOf<false>)]] B4 { ~B4(); };
...
template<bool B> struct [[trivially_relocatable(ValueOf<B>)]] C1 {};
template<bool B> struct [[trivially_relocatable(ValueOf<B>)]] C2 { ~C2(); };
...
template<class T> struct [[trivially_relocatable(sizeof(T)==1)]] C3 {};
