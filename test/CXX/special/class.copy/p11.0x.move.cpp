...
// expected-note@+1{{in implicit move constructor for 'Deleted' first required here}}
...
// expected-note@+1{{in implicit move constructor for 'DeletedMoveBase' first required here}}
